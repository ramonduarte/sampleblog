...
urlpatterns = [
    ...
    path('categories/<str:nicename>/', views.CategoryNameDetail.as_view()),
    path('tags/', views.TagList.as_view()),
    path('tags/<int:pk>/', views.TagDetail.as_view()),
    path('tags/<str:nicename>/', views.TagNameDetail.as_view()),
    path('statuses/', views.StatusList.as_view()),
    path('statuses/<int:pk>/', views.StatusDetail.as_view()),
    path('statuses/<str:nicename>/', views.StatusNameDetail.as_view()),
]
